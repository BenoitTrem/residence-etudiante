...
namespace S14_ProjetSessionTests.Integration.ProgrammeTests
{
    public class ModifierProgrammeTest : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public async Task Modifier_RelationProgrammeCampus_MiseAJour()
        {
            ...
            S14_ProjetSession.Models.Programme? programmeAvant = _programmesRepository.GetProgramme(1);
            ...
            S14_ProjetSession.Models.Programme? programmeApres = _programmesRepository.GetProgramme(1);
