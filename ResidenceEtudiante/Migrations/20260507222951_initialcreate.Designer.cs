...
namespace ResidenceEtudiante.Migrations
{
    ...
    [Migration("20260507222951_initialcreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResidenceEtudiante.Areas.Identity.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Campus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Commodite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Demande", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Etudiant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Jumelage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Programme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Residence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.ResidenceCommodite", b =>
                {
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Semestre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Unite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DemandeGenre", b =>
                {
                    b.HasOne("ResidenceEtudiante.Models.Demande", null)
                        .WithMany()
                        .HasForeignKey("DemandeGenresId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ResidenceEtudiante.Models.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ResidenceEtudiante.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Demande", b =>
                {
                    b.HasOne("ResidenceEtudiante.Models.Etudiant", "Etudiant")
                        .WithMany("Demandes")
                        .HasForeignKey("EtudiantId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ResidenceEtudiante.Models.Semestre", "Semestre")
                        .WithMany()
                        .HasForeignKey("SemestreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ResidenceEtudiante.Models.Unite", "Unite")
                        .WithMany("Demandes")
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Etudiant", b =>
                {
                    b.HasOne("ResidenceEtudiante.Areas.Identity.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("ResidenceEtudiante.Models.Campus", "Campus")
                        .WithMany("Etudiants")
                        .HasForeignKey("CampusId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ResidenceEtudiante.Models.Genre", "Genre")
                        .WithMany("Etudiants")
                        .HasForeignKey("GenreId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ResidenceEtudiante.Models.Programme", "Programme")
                        .WithMany("Etudiants")
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.Residence", b =>
                {
                    b.HasOne("ResidenceEtudiante.Models.Campus", null)
                        .WithMany("Residences")
                        .HasForeignKey("CampusId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("ResidenceEtudiante.Models.ResidenceCommodite", b =>
                {
                    b.HasOne("ResidenceEtudiante.Models.Commodite", "Commodite")
                        .WithMany("ResidenceCommodites")
                        .HasForeignKey("CommoditeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ResidenceEtudiante.Models.Residence", "Residence")
                        .WithMany("ResidenceCommodites")
